...
public class StringUtils {
    ...
    public static String[] split(String str, String regex) {
        return (StringUtils.isBlank(str) ? null : str.split(regex));
    }
    ...
    public static String[] split(String str, String startStr, String endStr, boolean isArray) {
        ...
        for (int i = 0; i < list.length; i++) {
            String s = list[i];
            if (StringUtils.contains(s, startStr)) {
                resultList[i] = s.substring(s.indexOf(startStr) + startStr.length());
            }
        }
        return resultList;
    }
